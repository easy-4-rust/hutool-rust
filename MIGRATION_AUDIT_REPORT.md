...
| 违规类型 | 文件数 | 状态 |
|---------|--------|------|
| 普通 .rs 文件含 2+ pub 类型 | 8 | ⚠️ 待修复 |
| 其中含 macro_rules!/thread_local! 的文件 | 7 | ⚠️ 需手动拆分 |
| 含 feature-gated 代码的文件 | 1 | ⚠️ qrcode.rs |
| 其中无 macro 的文件 | 1 | ⚠️ qrcode.rs (feature-gated) |
| lib.rs 含多类型定义 | 0 | ✅ 合规 |
| **总计违规** | **8** | |

**已成功拆分**: 151 个文件 (从 172 减少到 8)
