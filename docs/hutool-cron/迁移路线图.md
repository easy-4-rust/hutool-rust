...
| `cn.hutool.cron.pattern.CronPattern`（9 个公开/保护签名） | `crates/hutool-cron/src/pattern/cron_pattern.rs` | `IMPLEMENTED_VERIFIED` | 调用者、错误路径、副作用、源测试处置、E3/E4 差分 |
| `cn.hutool.cron.timingwheel.TimerTaskList`（8 个公开/保护签名） | `crates/hutool-cron/src/timingwheel/timer_task_list.rs` | `IMPLEMENTED_VERIFIED` | 调用者、错误路径、副作用、源测试处置、E3/E4 差分 |
| `cn.hutool.cron.pattern.matcher.DayOfMonthMatcher`（7 个公开/保护签名） | `crates/hutool-cron/src/pattern/day_of_month_matcher.rs` | `IMPLEMENTED_VERIFIED` | 调用者、错误路径、副作用、源测试处置、E3/E4 差分 |
| `cn.hutool.cron.pattern.CronPatternUtil`（6 个公开/保护签名） | `crates/hutool-cron/src/pattern/cron_pattern_util.rs` | `IMPLEMENTED_VERIFIED` | 调用者、错误路径、副作用、源测试处置、E3/E4 差分 |
| `cn.hutool.cron.pattern.matcher.BoolArrayMatcher`（6 个公开/保护签名） | `crates/hutool-cron/src/pattern/bool_array_matcher.rs` | `IMPLEMENTED_VERIFIED` | 调用者、错误路径、副作用、源测试处置、E3/E4 差分 |
